...
# 視覚タイプ
cat > public/images/result-v-light.svg << 'SVG_EOF'
<?xml version="1.0" encoding="UTF-8"?>
<svg width="1280" height="720" viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#69c4d0;stop-opacity:0.8" />
      <stop offset="50%" style="stop-color:#69c4d0;stop-opacity:0.9" />
      <stop offset="100%" style="stop-color:#69c4d0;stop-opacity:0.7" />
    </linearGradient>
    <filter id="noise">
...
cat > public/images/result-v-dark.svg << 'SVG_EOF'
<?xml version="1.0" encoding="UTF-8"?>
<svg width="1280" height="720" viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
