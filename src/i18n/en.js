export default {
    ...
    "results": {
        ...
        "va": {
            ...
            "description": "Congratulations! You are the type best suited for the popular ‘learning by video’ method. You’ll likely adapt well to school or lecture-style learning. Try focusing more on whichever score is higher."
        },
        "vt": {
        ...
        "all": {
            "title": "All-rounder",
            "description": "No clear difference in your results!? In that case… we recommend muscle training! 💪<br>Muscles save the world. Start with squats and protein!<br>(※This is a joke. This test cannot decide your type, so try focusing on the category where your score is the highest.)"
        }
    },
    "notices": [
